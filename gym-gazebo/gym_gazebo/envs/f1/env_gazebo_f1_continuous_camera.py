...
class GazeboF1CameraEnvContinuous(gazebo_env.GazeboEnv):
    """
    Description:
    ...
    def _generate_simple_action_space():
        ...
        action_min = [min_lin_speed, -max_ang_speed]
        action_max = [max_lin_speed, max_ang_speed]

        action_space = spaces.Box(np.array(action_min), np.array(action_max))
